...
Both variables are categorical; each with 2 levels. Thus, we will use a chi-squared and a fisher xy test for odd ratios. OWNGUN YES/NO. CAPPUN has YES/NO. 
...
This table shows that if you believe in capital punishment you are likely not in favor of either yes or no. If you are opposed of capital punishment you are likely to say no 71% of the time. This table shows that if you are 18% more likely to say no. 
...
The median for the voted category is 15. The median for the did not vote category is 13. There is 3 outliers in the did not vote category. The 1.5 IQR for the voted box plot is a lot lengthier than the did not vote.
The IOR for the Voted category is much higher than the did not voted. currently, there is clearly a difference between the two.
...
The t-value is 4.598. The degrees of freedom is 102.27. The p-value 15 0.00001224. Thus, we can reject the
null hypothesis since the p-value is too small. There is clearly a difference between the two variables.
